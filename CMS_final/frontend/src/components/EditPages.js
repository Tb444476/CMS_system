...
// //         <h2>Admin Panel</h2>
// //         <button onClick={() => navigate('/')}>Back to Admin Panel</button>
// //       </div>
...
//                 <button className="edit-button" onClick={() => editContent(file.title)}>Edit</button>
//                 <button className="delete-button" onClick={() => deleteContent(file.title)}>Delete</button>
//               </div>
//             </li>
//           ))}
//         </ul>
